...
import AssignParent from './studentRelated/AssignParent';
        ...
        <>
            <Box sx={{ display: 'flex' }}>
                ...
                <AppBar open={open} position='absolute' style={{backgroundColor:"#7F00FF"}}>
                    <Toolbar sx={{ pr: '24px' }} style={{position:'sticky', top:0}}>
                        <IconButton
                            edge="start"
                            color="inherit"
                ...
                <Box component="main" sx={styles.boxStyled}>
                    ...
                    <Routes>
                        ...
                        {/* Classroom */}
                        {/* <Route path="/Admin/addclassroom" element={<AddClassroom />} /> */}
                        {/* <Route path="/Admin/classes" element={<ShowClasses />} />
                        <Route path="/Admin/classes/class/:id" element={<ClassDetails />} />
                        <Route path="/Admin/class/addstudents/:id" element={<AddStudent situation="Class" />} /> */}
                        ...
                        <Route path="/Admin/students/student/update/:id" element={<UpdateStudent situation="Student" />} />
                        <Route path="/Admin/students/student/attendance/:id" element={<StudentAttendance situation="Student" />} />
                        <Route path="/Admin/students/student/assignParent/:id" element={<AssignParent situation="Student" />} />
                        ...
                        {/*<Route path="/Admin/teachers/choosesubject/:id" element={<ChooseSubject situation="Norm" />} />
                        <Route path="/Admin/teachers/choosesubject/:classID/:teacherID" element={<ChooseSubject situation="Teacher" />} /> */}
                        <Route path="/Admin/parent" element={<AddParent situation="Student" />} />
