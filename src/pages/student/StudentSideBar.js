        ...
        <>
            <React.Fragment>
                ...
                <ListItemButton component={Link} to="/Student/sendmessage">
                    <ListItemIcon>
                        <EmailIcon color={location.pathname.startsWith("/Student/sendmessage") ? 'primary' : 'inherit'} />
                    </ListItemIcon>
                    <ListItemText primary="Message" />
                </ListItemButton>
                <ListItemButton component={Link} to="/Student/seemessages">
                    <ListItemIcon>
                        <AnnouncementOutlinedIcon color={location.pathname.startsWith("/Student/seemessages") ? 'primary' : 'inherit'} />
                    </ListItemIcon>
